def source1df():
    ...
    metric = 'hbond'
    include = 'p-w'
    #file_names = ['hbond01-26.xvg', 'hbond27-57.xvg', 'hbond01-16.xvg', 'hbond17-37.xvg', 'hbond38-57.xvg']
    #exception = '/t37/t37_1'
        ...
        for p in phs:
            for tr in trials:
                ...
                if os.path.exists(cur_path):
                    # Get all hbond files, excluding hbond-p-w
                    file_names = []
                    for file in os.listdir(cur_path):
                        if metric in file and include in file:
                    ...
                    for i in range(len(all_file_data) - 1):
                        ...
                        if not math.isclose(cur_file_data[0][0] - last_timestamp, 0.1, rel_tol = 0.6):
