        ...
        for tr in trials:
            ...
            if os.path.exists(cur_path):
                ...
                for file in os.listdir(cur_path):
                    if metric in file and not exclude in file:
...
for t in temps:
    for p in phs:
        ...
        if os.path.exists(cur_path):
            ...
            file_names = []
            for file in os.listdir(cur_path):
                if metric in file and not exclude in file and not exclude2 in file:
                    file_names.append(file)
